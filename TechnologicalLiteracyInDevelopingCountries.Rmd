...
```
\begin{center}
Figure 6 - The plot above shows the percentage of individuals who completed at least one task from each quintile.  
\end{center}
